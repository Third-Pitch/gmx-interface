...
const tokens = [
  {
    ...
    iouToken: getContract(CHAIN_ID, "GMT_EDDX_IOU"),
    cap: MaxUint256,
    bonus: 0,
  },
  {
    ...
    iouToken: getContract(CHAIN_ID, "XGMT_EDDX_IOU"),
    cap: MaxUint256,
    bonus: 0,
  },
  {
    ...
    iouToken: getContract(CHAIN_ID, "GMT_USDG_EDDX_IOU"),
  ...
  },
  {
    ...
    iouToken: getContract(CHAIN_ID, "XGMT_USDG_EDDX_IOU"),
