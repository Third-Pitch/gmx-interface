        ...
        <div className="StakeV2-cards">
          <div className="App-card StakeV2-eddx-card">
            ...
            <div className="App-card-content">
              ...
              <div className="App-card-buttons m-0">
                <Button variant="semi-clear" to="/buy_eddx">
                  <Trans>Buy on Goerli</Trans>
                </Button>
                {active && (
                  <Button variant="semi-clear" onClick={() => showStakeEddxModal()}>
                    <Trans>Stake</Trans>
                  </Button>
                )}
                {active && (
                  <Button variant="semi-clear" onClick={() => showUnstakeEddxModal()}>
                    <Trans>Unstake</Trans>
                  </Button>
                )}
                {active && (
          ...
          <div className="App-card">
            ...
            <div className="App-card-content">
              ...
              <div className="App-card-divider"></div>
              <div className="App-card-buttons m-0">
                <Button variant="semi-clear" to="/buy_elp">
                  <Trans>Buy ELP</Trans>
                </Button>
                <Button variant="semi-clear" to="/buy_elp#redeem">
          ...
          <div className="App-card">
            ...
            <div className="App-card-content">
              ...
              <div className="App-card-buttons m-0">
                {active && (
                  <Button variant="semi-clear" onClick={() => showStakeEsEddxModal()}>
                    <Trans>Stake</Trans>
                  </Button>
                )}
                {active && (
                  <Button variant="semi-clear" onClick={() => showUnstakeEsEddxModal()}>
                    <Trans>Unstake</Trans>
                  </Button>
                )}
                {!active && (
            ...
            <div className="App-card StakeV2-eddx-card">
              ...
              <div className="App-card-content">
                ...
                <div className="App-card-buttons m-0">
                  ...
                  {active && (
                    <Button variant="semi-clear" onClick={() => showEddxVesterDepositModal()}>
                      <Trans>Deposit</Trans>
                    </Button>
                  )}
                  {active && (
                    <Button variant="semi-clear" onClick={() => showEddxVesterWithdrawModal()}>
            ...
            <div className="App-card StakeV2-eddx-card">
              ...
              <div className="App-card-content">
                ...
                <div className="App-card-buttons m-0">
                  ...
                  {active && (
                    <Button variant="semi-clear" onClick={() => showElpVesterDepositModal()}>
                      <Trans>Deposit</Trans>
                    </Button>
                  )}
                  {active && (
                    <Button variant="semi-clear" onClick={() => showElpVesterWithdrawModal()}>
                      <Trans>Withdraw</Trans>
                    </Button>
                  )}
                </div>
